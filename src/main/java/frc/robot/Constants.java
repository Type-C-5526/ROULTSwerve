...
public final class Constants {
    public static final class chassisConstants{
        ...
        public static final double wheelBase = (27);
    ...
    public static final class chassisSetUp{
        //Front Left Module
        public static final int fLeftDriveMotorPort = 20;
        public static final int fLeftTurnMotorPort = 5;
        ...
        public static final double frontLAngle = -144;
        public static final double frontLKP = 0.05;
        public static final double frontLKI = 0.0;
        public static final double frontLKD = 0.0;
        

        //Front Right Module
        public static final int fRightDriveMotorPort = 21;
        public static final int fRightTurnMotorPort = 6;
        ...
        public static final double frontRAngle = -91;
        public static final double frontRKP = 0.05;
        public static final double frontRKI = 0.0;
        public static final double frontRKD = 0.0;

        //Back Right Module
        public static final int bRightDriveMotorPort = 4;
        ...
        public static final double backRAngle = -91;
        public static final double backRKP = 0.05;
        public static final double backRKI = 0.0;
        public static final double backRKD = 0.0;

        //Back Left Module
        public static final int bLeftDriveMotorPort = 3;
        public static final int bLeftTurnMotorPort = 7;
        public static final boolean isBackLeftDriveMotorReverse = true;
        public static final boolean isBackLeftTurnMotorReverse = true;
        public static final int bLeftAbsoluteEncoder = 5;
        public static final double backLAngle = 103;
        public static final double backLKP = 0.05;
