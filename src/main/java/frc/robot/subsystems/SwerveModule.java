...
public class SwerveModule extends SubsystemBase {
  ...
  public SwerveModuleState getState(){
    ...
    double velocity = m_driveMotor.getEncoder().getVelocity();
    Rotation2d angle = getTurnAngle();
    return new SwerveModuleState(velocity, angle);
  }
  public SwerveModulePosition getPosition(){
    return new SwerveModulePosition(falconToMeters(m_driveMotor.getEncoder().getPosition(), chassisConstants.circumference, chassisConstants.driveMotorGearRat), getTurnAngle());
  }
  ...
  public void stop(){
    ...
    turnMotor.set(ControlMode.Position, getState().angle.getDegrees() * chassisConstants.turnMotorGearRat);
  }
  @Override
